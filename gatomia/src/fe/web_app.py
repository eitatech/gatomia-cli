...
app = FastAPI(
    title="GatomIA", description="Generate comprehensive documentation for any GitHub repository"
)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="GatomIA Web Application - Generate documentation for GitHub repositories"
    )
    parser.add_argument(
        "--host",
        type=str,
    ...
    print(f"🚀 GatomIA Web Application starting...")
