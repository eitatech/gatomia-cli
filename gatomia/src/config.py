...
# LLM services
# In CLI mode, these will be loaded from ~/.gatomia/config.json + keyring
# In web app mode, use environment variables
MAIN_MODEL = os.getenv("MAIN_MODEL", "deepseek-chat")
FALLBACK_MODEL_1 = os.getenv("FALLBACK_MODEL_1", "deepseek-chat")
...
@dataclass
class Config:
    """Configuration class for GatomIA."""
    ...
    def from_args(cls, args: argparse.Namespace) -> "Config":
        ...
        return cls(
            ...
            fallback_model=getattr(args, "fallback_model", FALLBACK_MODEL_1),
            llm_provider=getattr(args, "llm_provider", LLM_PROVIDER),
            copilot_token=getattr(args, "copilot_token", COPILOT_TOKEN),
        )
