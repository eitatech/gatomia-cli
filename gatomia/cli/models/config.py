"""
Configuration data models for GatomIA CLI.

This module contains the Configuration class which represents persistent
user settings stored in ~/.gatomia/config.json. These settings are converted
...
class Configuration:
    """
    GatomIA configuration data model.
    ...
    def to_dict(self) -> dict:
        ...
        if self.copilot_token:
            result["copilot_token"] = self.copilot_token
    ...
    def from_dict(cls, data: dict) -> "Configuration":
        ...
        return cls(
            ...
            fallback_model=data.get("fallback_model", "deepseek-chat"),
    ...
    def is_complete(self) -> bool:
        ...
        base_complete = bool(self.main_model and self.cluster_model and self.fallback_model)
        if self.llm_provider == "openai":
            return base_complete and bool(self.base_url)
