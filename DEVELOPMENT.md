...
This guide provides information for developers who want to contribute to or extend GatomIA.

## Project Structure

```
gatomia/
├── gatomia/                 # Main package
...
git clone https://github.com/eitatech/GatomIA.git
cd GatomIA
...
2. **Persistent Config** (`~/.gatomia/config.json`) → Default `AgentInstructions`
...
- GitHub Issues: https://github.com/eitatech/GatomIA/issues
